...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    guessNum.text = [NSString stringWithFormat:@"%d", history.guessNum];
    UILabel *countGuess = (UILabel*) [cell viewWithTag:104];
    countGuess.text =  [NSString stringWithFormat:@"%d",history.countGuess];
    return cell;
}
